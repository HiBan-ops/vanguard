// Responsibility: Defines data/state contracts used by the Operator persistence/domain models, centered on Operator Contact History Entry.
...
public sealed record VanguardOperatorContactHistoryEntry(
    string EventId,
    string Type,
    string Summary,

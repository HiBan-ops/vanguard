// Responsibility: Defines data/state contracts used by the Operator persistence/domain models, centered on Operator Identity.
...
public sealed record VanguardOperatorIdentity(
    string OperatorId,
    string FirstName,
    string LastName,
    string Callsign,

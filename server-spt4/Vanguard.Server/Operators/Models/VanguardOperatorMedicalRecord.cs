// Responsibility: Defines data/state contracts used by the Operator persistence/domain models, centered on Operator Medical Record.
...
public sealed record VanguardOperatorMedicalRecord(
    string OperatorId,
    string DisplayName,
    string Status,

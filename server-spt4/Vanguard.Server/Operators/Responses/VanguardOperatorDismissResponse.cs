...
public sealed record VanguardOperatorDismissResponse(
    bool Success,
    string RequestedProfileId,
    string StorageProfileId,
    string Reason,
    VanguardOperatorProfile? ReleasedOperator,
    VanguardActiveServiceRecord? ReleasedActiveService,
    VanguardOperatorDeploymentLimits Limits,
    int RemainingOperatorCount,
